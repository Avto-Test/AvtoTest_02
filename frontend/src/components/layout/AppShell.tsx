            ...
            <footer className="border-t border-border/40 bg-muted/30">
                <div className="container-app py-12">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        <div className="space-y-4">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Professional online testing platform for driving license preparation.
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <ul className="space-y-2 text-sm text-muted-foreground">
                                <li><Link href="/tests?mode=adaptive" className="hover:text-foreground transition-colors">Tests</Link></li>
                    ...
                    <div className="mt-8 pt-8 border-t border-border/40 flex flex-col md:flex-row justify-between items-center gap-4">
                        <p className="text-sm text-muted-foreground">
                            © 2026 AUTOTEST. All rights reserved.
                        </p>
